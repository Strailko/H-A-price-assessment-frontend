...
export class LandingComponent implements OnInit {
  ...
  latitude: number = 41.581;
  longitude: number = 21.7;
  zoom: number = 7.8;
  marker: marker = {
    lat: this.latitude,
    lng: this.longitude,
  ...
  constructor(private mapsAPILoader: MapsAPILoader, private ngZone: NgZone, private dataService: DataService, private _formBuilder: FormBuilder, private breakpointObserver: BreakpointObserver) {}
  ...
  calculate() {
    if(this.firstFormGroup.value['selectedType']  === this.type.CAR) {
      ...
      this.flatObj.longitude = this.longitude;
      this.flatObj.latitude = this.latitude;
      ...
      this.houseObj.longitude = this.longitude;
      this.houseObj.latitude = this.latitude;
